...
function header() {
  return (
    <header>
      <nav className="h-[76px] px-def bg-translucent flex place-content-between font-jakarta font-normal text-white text-sm items-center fixed top-0 left-0 right-0 z-50">
        <section className="flex cursor-pointer gap-[68px]">
          <div className="flex gap-[15px] items-center">
            <img className="" src="/assets/img/coffe-main-logo.svg" alt="coffe-shop-logo" />
            <a href="#" className="font-sacramento text-xl w-[86px]">
              Coffee Shop
            </a>
          </div>
